...
namespace RedLockNet
{
	public interface IDistributedLockFactory
	{
		...
		IRedLock CreateLock(string resource, TimeSpan expiryTime,string lockInfo = null);
		...
		/// RedLocks will automatically extend if the process that created the RedLock is still alive and the RedLock hasn't been disposed.</param>
		/// <returns>A RedLock object.</returns>
		Task<IRedLock> CreateLockAsync(string resource, TimeSpan expiryTime,string lockInfo = null);
		...
		/// <returns>A RedLock object.</returns>
		IRedLock CreateLock(string resource, TimeSpan expiryTime, TimeSpan waitTime, TimeSpan retryTime, CancellationToken? cancellationToken = null,string lockInfo = null);
		...
		/// <param name="cancellationToken">CancellationToken to abort waiting for blocking lock.</param>
		/// <returns>A RedLock object.</returns>
		Task<IRedLock> CreateLockAsync(string resource, TimeSpan expiryTime, TimeSpan waitTime, TimeSpan retryTime, CancellationToken? cancellationToken = null,string lockInfo = null);
	}
}